...
var AuthRepository = /*#__PURE__*/_createClass(function AuthRepository(userModel) {
        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              url = "".concat(req.protocol, "://localhost:3001/");
              _context.next = 6;
      ...
      var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee4(req, res, next) {
        ...
        return _regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 10:
              _context4.prev = 10;
              resetURL = "".concat(req.protocol, "://localhost:3001/changePassword/").concat(resetToken);
              _context4.next = 14;
  ...
  _defineProperty(this, "checkPassword", function () {
    return catchAsync(/*#__PURE__*/function () {
        ...
        return _regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 3:
              ...
              return _context6.abrupt("return", next(new AppError("Token is invalid or has expeired", 400)));
            case 6:
        ...
        return _regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              ...
              return _context8.abrupt("return", next(new AppError("This route is not for password updates. Please use /changePassword.", 400)));
            case 2:
        ...
        return _regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 5:
              ...
              break;
            case 10:
              return _context9.abrupt("return", next(AppError(customResourceResponse.jwtNotValid.message, customResourceResponse.jwtNotValid.statusCode)));
            case 11:
              _context9.next = 16;
              break;
            case 13:
              ...
              return _context9.abrupt("return", next(AppError("Refresh token is not valid.Please sign in again", 500)));
            case 16:
            case "end":
  ...
  _defineProperty(this, "findUserByToken", /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee10(refreshToken) {
