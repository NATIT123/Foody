...
var router = Router();
import { addRestaurant, getAllRestaurants, deleteRestaurantById, updateRestaurantById, getRestaurantById, getRestaurantByOptions, getRestaurantByCity, getRestaurantTopDeals, getRestaurantByFields, getRestaurantByRecommendation, getNearestRestaurants, getRestaurantByViews, findRestaurantsByFields, getRestaunrantsPending, updateStatus, getOwnerRestaurants, fetchRestaurantsByRate } from "../controllers/restaurantController.js";
...
router.get("/getRestaurantByOptions/city/:cityId/category/:categoryId", getRestaurantByOptions);
...
router.post("/getRestaurantByRecommendation/:restaurantId/:userId", getRestaurantByRecommendation);
