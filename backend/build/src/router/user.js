...
var router = Router();
import { addUser, updateUserById, deleteUserById, getAllUsers, getUserById, uploadPhoto, getUserDetails, getAllDetails, findUsersByFields, getChatBotResponse, findUsersByRole } from "../controllers/userController.js";
import { signUp, logIn, forgotPassword, changePassword, protect, resetPassword, restrictTo, logOut, getMe, updateMe, deleteMe, refreshToken, checkPassword } from "../controllers/authController.js";
